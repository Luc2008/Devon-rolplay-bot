...
module.exports.run = async (bot, message, args) => {
    ...
    if (!banUser) return message.reply("Sorry kan de opgegeven gebruiker niet vinden.");

    if (banUser.permissions.has("MANAGE_MESSAGES")) return message.reply('je kan deze persoon niet bannen!');
...
module.exports.help = {
    name: "ban",
    category: "general",
    description: "geeft bans alleen 'alleen staff kan dit'"
}