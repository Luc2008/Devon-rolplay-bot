...
module.exports.run = async (bot, message, args) => {
    ...
    if (warnUser.permissions.has("MANAGE_MESSAGES")) return message.reply("Sorry je kan deze persoon geen waarschuwing geven");
    ...
    const channel = message.member.guild.channels.cache.get("922158098058194964");
